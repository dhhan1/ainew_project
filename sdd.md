...
# 위임 범위가 커지면, 경계도 단단해져야 한다 | SDD (/learn/completing-projects/spec-driven-development/sdd)
...
## 도구는 모았지만 시작점이 비어 있다 [#도구는-모았지만-시작점이-비어-있다]
...
## SDD: 명세를 입력으로 6단계를 닫는다 [#sdd-명세를-입력으로-6단계를-닫는다]
...
## Spec이 나머지를 결정한다 [#spec이-나머지를-결정한다]
